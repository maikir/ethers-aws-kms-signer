...
describe("getEthereumAddress", () => {
  test("should work correctly", () => {
    ...
    expect(getEthereumAddress(samplePubKey)).toBe(
...
describe("findEthereumSig", () => {
  test("should work correctly", () => {
    ...
    const { r, s } = findEthereumSig(sampleSignature);
    expect(r.toString(16)).toEqual(
      "3f25afdb7ed67094101cd71109261886db9abbf1ba20cc53aec20ba01c2e6baa"
    );
    expect(s.toString(16)).toEqual(
      "54f2192bf0769f3dad0390de1ca17c95a83f2b567b5796e7fba7fd166a0061bf"
    );
  });
});
...
describe("determineCorrectV", () => {
  ...
  test("should ??? if somethings are invalid", () => {
    ...
    const sampleR = BigInt(
      "0x777ceae0232282cbf6da3809a678541cdef7f4f3328242641ceecb0dc"
    );
    const sampleS = BigInt(
      "0x5b7f7afe18221049a1e176a89a60b6c10df8c0e838edb9b2f11ae1fb50a28271"
    );
